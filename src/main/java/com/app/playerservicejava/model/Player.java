...
public class Player {
    ...
    /*
    String playerId, birthYear, birthMonth, birthDay,  birthCountry, birthState, birthCity;
    String deathYear, deathMonth, deathDay, deathCountry, deathState, deathCity, firstName, lastName;
    String givenName, weight, height, bats, throwStats, debut, finalGame, retroId, bbrefId;
     */
    ...
    protected void generateId() {
        if (this.playerId == null) {
            this.playerId = UUID.randomUUID().toString().replace("-", "").substring(0, 8);
        }
    }
